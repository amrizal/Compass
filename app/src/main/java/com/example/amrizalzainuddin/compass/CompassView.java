...
public class CompassView extends View {
    ...
    private void initCompassView() {
        ...
        borderGradientPositions[1] = 1-0.6f;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        LinearGradient skyShader = new LinearGradient(center.x, innerBoundingBox.top,
                center.x, innerBoundingBox.bottom, skyHorizonColorFrom, skyHorizonColorTo, Shader.TileMode.CLAMP);
        ...
        for(int i=90; i>=-90; i-=10){
            ...
            //draw a line and the tilt andle for each scale increment
        ...
        canvas.drawLine(center.x - radius / 2, (float) justTiltY, center.x + radius / 2,
                (float) justTiltY, markerPaint);
        markerPaint.setStrokeWidth(1);
